...
contract DeferredEquityPlan {
    ...
    uint public unlockTime = start_time + 365 days;
    ...
    function distribute() public {
        ...
        require(unlockTime <= fakenow, 'This years shares have already been awarded');
        require(distributed_shares < totalShares, 'All shares have been awarded');
        ...
        distributed_shares = ((fakenow - start_time) / 365 days * annualDistribution);
